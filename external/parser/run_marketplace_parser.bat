...
REM Run the parser
if exist MarketplaceParser.py (
    echo Running MarketplaceParser.py... >>"%LOGFILE%"
    python MarketplaceParser.py >>"%LOGFILE%" 2>&1
    echo MarketplaceParser.py finished. >>"%LOGFILE%"
) else (
    echo ERROR: MarketplaceParser.py not found! >>"%LOGFILE%"
    echo ERROR: MarketplaceParser.py not found!
)
